...
<div id="box">
    ...
    <div id="content">
        ...
        <div id="conteudo">
            ...
            $perfil = mysql_query("select nome, senha, email, id, usuario from users where id = '$id_user'") or die(mysql_error());
            ...
            <form name="editar" action="" enctype="multipart/form-data" method="post" class="form">
                ...
                <input type="hidden" name="user_id" value="<?php echo $id_perfil;?>">
